...
class Admin::ActionLogFilter
  ...
  ACTION_TYPE_MAP = {
    ...
    create_custom_template: { target_type: 'CustomTemplate', action: 'create' }.freeze,
    ...
    destroy_custom_template: { target_type: 'CustomTemplate', action: 'destroy' }.freeze,
    ...
    disable_custom_template: { target_type: 'CustomTemplate', action: 'disable' }.freeze,
    disable_user: { target_type: 'User', action: 'disable' }.freeze,
    enable_custom_emoji: { target_type: 'CustomEmoji', action: 'enable' }.freeze,
    enable_custom_template: { target_type: 'CustomTemplate', action: 'enable' }.freeze,
